-- Registro de Alumnos  tres de las tablas tienen los 3 comandos que se 
-- solicitaron y las otras 5 solotiene el comando Insert.

-- TABLA CAMPUS
-- Insert para insertar informacion a los campos de las tablas
...
-- Update para actualiza los campos de las tablas
...
-- Delete para eliminar los capos de las tablas
...
-- Udate para actualiza los campos de las tablas
